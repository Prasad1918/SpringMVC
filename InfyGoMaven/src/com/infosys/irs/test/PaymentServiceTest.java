...
public class PaymentServiceTest 
{
	...
	public void testFindCreditCardNegative1() throws CreditCardNotFoundException,InvalidCardDetailsException
	{
		...
		Mockito.when(creditCardRepository.findById(Mockito.anyString()).get()).thenReturn(null);
	...
	public void testFindCreditCardNegative2() throws CreditCardNotFoundException,InvalidCardDetailsException
	{
		...
		Mockito.when(creditCardRepository.findById(Mockito.anyString()).get()).thenReturn(creditCardEntity1);
		paymentService.findCreditCard(creditCard);
	}
	...
	public void testConfirmBooking() 
	{
		...
		Mockito.when(userRepository.findById(Mockito.anyString()).get()).thenReturn(userEntity);
		Mockito.when(flightRepository.findById(Mockito.anyString()).get()).thenReturn(flightEntity);
