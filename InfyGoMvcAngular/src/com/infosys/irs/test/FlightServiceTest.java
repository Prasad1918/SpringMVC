...
public class FlightServiceTest {
	...
	public void testUpdateFlightPositive()
	{
		...
		FlightEntity flightEntityReturned = flightRepository.findById(Mockito.anyString()).get();
	...
	public void testUpdateFlightNegative() throws ARSServiceException
	{
		...
		Mockito.when(flightRepository.findById(Mockito.anyString()).get()).thenReturn(null);
