	...
	<nav class="navbar st-navbar navbar-fixed-top">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="logo1" href="register.jsp"> <img id="a"
					src="<c:url value='/resources/images/infygonew.PNG'/>"></img>
				</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="st-navbar-collapse">
				<div class="">
					...
					<ul class="nav navbar-nav navbar-right margintop-5 ">
				        ...
				        <li><a class="btn btn-md  nav-links-right  " href="Login.jsp" style="margin-top:10px;border-top-width:1px">
